...
//
	...
	protected void service(HttpServletRequest request, HttpServletResponse arg1) throws ServletException, IOException {
		...
		getServletContext().getRequestDispatcher(view).equals(forward(request,response));
	...
	private String list(HttpServletRequest request, HttpServletResponse arg1) throws ServletException, IOException {
		String action = request.getParameter("action");
